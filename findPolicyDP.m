function [splineList,policyToApply] = findPolicyDP(transitionMatrix,...
...
% I go backward in time in order to find all the spline from the time
% 'numYears-1' to the time 1. I do not need to find the spline for the time
% 0 because I do not need it in the part of the simulation
for t=numYears:-1:2
    ...
    for i=1:3
        ...
        % estimate the spline of the value function of time t and working
        % condition i
